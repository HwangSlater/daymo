...
```json
{ "text": "[네이버지도]\n달빛한옥\n전주 한옥마을 은행로 12 달빛한옥\nhttps://map.naver.com/p/search/장소" }
```
...
```json
{
  "data": {
    ...
    "url": "https://map.naver.com/p/search/장소",
...
`GET /spaces/{spaceId}/search?q=소나기식당&types=trip,place,schedule,recipe,packing,memo&limit=20`
