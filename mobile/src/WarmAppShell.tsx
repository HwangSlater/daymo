...
const s = StyleSheet.create({
  ...
  paperTripStampMonth: { fontSize: 11, fontFamily: typo.data.family, letterSpacing: 1 },
  ...
  paperTripActionLabel: { fontSize: 11, fontFamily: typo.label.family, letterSpacing: 0 },
  ...
  mapTrayTitle: { color: "#17233D", fontSize: 16, fontFamily: typo.title.family },
  ...
  zoomResetText: { fontSize: 11, fontFamily: typo.label.family },
  ...
  calendarResultClear: { fontSize: 11, fontFamily: typo.label.family },
  ...
  rangeMonthTitle: { color: "#17233D", fontSize: 14, fontFamily: typo.title.family },
  ...
  calendarTodayText: { color: "#596071", fontSize: 11, fontFamily: typo.label.family },
  ...
  calendarLegendText: { color: "#6F716F", fontSize: 11, fontFamily: typo.label.family },
  ...
  weekName: { width: "14.285%", textAlign: "center", color: "#85888D", fontSize: 11, fontFamily: typo.title.family },
  ...
  searchCategoryCountText: { fontSize: 11, fontFamily: typo.data.family },
  searchGuideHead: {
    height: 26,
    flexDirection: "row",
    alignItems: "center",
  ...
  searchRecentClear: { fontSize: 11, fontFamily: typo.label.family },
  ...
  historyTitle: { fontSize: 16, fontFamily: typo.title.family, marginTop: 4 },
