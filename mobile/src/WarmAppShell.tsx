...
const s = StyleSheet.create({
  ...
  notebookHello: { fontSize: 11, marginTop: 3, fontFamily: typo.body.family },
  tinyDay: {
  ...
  paperKicker: { fontSize: 11, fontFamily: typo.label.family, marginBottom: 7 },
  ...
  paperStayName: { fontSize: 13, fontFamily: typo.title.family, marginTop: 3 },
  paperStayTime: {
    minWidth: 58,
    minHeight: 40,
    borderRadius: 11,
  ...
  paperStayTimeValue: { fontSize: 12, fontFamily: typo.data.family, marginTop: 1 },
  paperTripActions: {
    flexDirection: "row",
    marginTop: 14,
    marginHorizontal: -19,
  ...
  paperTripActionMeta: { color: "#756F63", fontSize: 10, fontFamily: typo.caption.family, marginTop: 3 },
  ...
  homeArchivePlace: { fontSize: 15, fontFamily: typo.label.family, marginTop: 5 },
  ...
  noTripsTitle: { fontSize: 14, fontFamily: typo.title.family, marginTop: 10 },
  ...
  oauthMark: { fontSize: 12, fontFamily: typo.label.family, marginRight: 7 },
  ...
  authDividerText: { fontSize: 11, fontFamily: typo.label.family, marginHorizontal: 10 },
  ...
  workspaceName: { fontSize: 14, fontFamily: typo.title.family, marginTop: 3 },
  ...
  memberSectionTitle: { fontSize: 14, fontFamily: typo.title.family, marginTop: 3 },
  memberManageText: { fontSize: 11, fontFamily: typo.label.family, paddingVertical: 5 },
  ...
  managementLabel: { fontSize: 11, fontFamily: typo.label.family, marginTop: 15, marginBottom: -2 },
  ...
  memberManagerRole: { fontSize: 11, fontFamily: typo.label.family, marginTop: 3 },
  memberEditor: { borderRadius: 13, padding: 14 },
  memberEditorEyebrow: { fontSize: 11, fontFamily: typo.label.family, marginBottom: 9 },
