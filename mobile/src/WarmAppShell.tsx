...
const s = StyleSheet.create({
  ...
  artText: { color: "#623C38", fontSize: 13, fontFamily: typo.label.family },
  artLine: { width: 25, height: 2, backgroundColor: "#623C38", marginTop: 4 },
  newTripText: { color: "#FFF9F4", fontSize: 11, fontFamily: typo.label.family },
  ...
  notebookHello: { fontSize: 11, marginTop: 2, fontFamily: typo.body.family },
  tinyDay: {
  ...
  tinyDayText: { fontSize: 11, fontFamily: typo.data.family },
  paperTripStack: {
    position: "relative",
    marginBottom: 2,
  },
  ...
  paperKicker: { fontSize: 11, fontFamily: typo.label.family, marginBottom: 6 },
  paperTitle: { fontSize: 28, fontFamily: typo.title.family, letterSpacing: -1.3 },
  ...
  paperTripStampMonth: { fontSize: 11, fontFamily: typo.data.family, letterSpacing: 0.8 },
  ...
  paperStayLabel: { fontSize: 11, fontFamily: typo.label.family },
  paperStayName: { fontSize: 13, fontFamily: typo.title.family, marginTop: 2 },
  paperStayTime: {
    minWidth: 58,
    minHeight: 40,
    borderRadius: 12,
  ...
  paperStayTimeLabel: { fontSize: 11, fontFamily: typo.label.family },
  paperStayTimeValue: { fontSize: 12, fontFamily: typo.data.family, marginTop: 2 },
  paperTripActions: {
    flexDirection: "row",
    marginTop: 12,
  ...
  paperTripActionLabel: { fontSize: 11, fontFamily: typo.label.family, letterSpacing: -0.2 },
  paperTripActionMeta: { color: "#756F63", fontSize: 10, fontFamily: typo.caption.family, marginTop: 2 },
  ...
  noteTitleSmall: { fontSize: 11, fontFamily: typo.label.family, marginBottom: 4 },
  noteTitle: { fontSize: 20, fontFamily: typo.title.family, letterSpacing: -0.6 },
  memoPaper: {
    marginTop: 0,
    borderWidth: 1,
    borderRadius: 8,
  ...
  memoText: { fontSize: 12, fontFamily: typo.body.family },
  ...
  homeArchiveEyebrow: { fontSize: 11, fontFamily: typo.label.family, marginBottom: 4 },
  homeArchiveTitle: { fontSize: 18, fontFamily: typo.title.family, letterSpacing: -0.5 },
  homeArchiveMore: { fontSize: 11, fontFamily: typo.label.family },
  ...
  homeArchivePlace: { fontSize: 15, fontFamily: typo.label.family, marginTop: 4 },
  homeArchiveNote: { fontSize: 11, lineHeight: 15, marginTop: 4 },
  homeArchiveAction: { fontSize: 11, fontFamily: typo.label.family, marginTop: "auto", paddingTop: 8 },
  homeEmptyTrip: {
    minHeight: 250,
    borderRadius: 8,
    borderWidth: 1,
  ...
  homeEmptyTripMarkText: { fontSize: 22, fontFamily: typo.label.family },
  homeEmptyTripTitle: { fontSize: 17, fontFamily: typo.title.family, textAlign: "center" },
  homeEmptyTripCopy: {
    maxWidth: 270,
    fontSize: 11,
    lineHeight: 17,
  ...
  homeEmptyTripActionText: { color: "#FFFFFF", fontSize: 12, fontFamily: typo.label.family },
  safe: {
    flex: 1,
    width: "100%",
    maxWidth: 430,
  ...
  infoSheetDoneText: { fontSize: 13, lineHeight: 17, fontFamily: typo.label.family },
  ...
  viewChoiceText: { color: "#858783", fontSize: 13, fontFamily: typo.label.family },
  ...
  mapTrayTitle: { color: "#17233D", fontSize: 15, fontFamily: typo.title.family },
  ...
  mapTrayMarkText: { color: "#FFFFFF", fontSize: 11, fontFamily: typo.label.family },
  mapTrayCopy: { flex: 1, paddingHorizontal: 8 },
  mapTrayName: { color: "#17233D", fontSize: 12, fontFamily: typo.title.family },
  ...
  pinCountText: { color: "#17233D", fontSize: 11, fontFamily: typo.data.family },
  zoomControls: {
    position: "absolute",
    right: 5,
    bottom: 14,
  ...
  zoomText: { color: "#17233D", fontSize: 19, fontFamily: typo.title.family },
  zoomResetText: { fontSize: 10, fontFamily: typo.label.family },
  ...
  calendarResultClear: { fontSize: 10, fontFamily: typo.label.family },
  emptyDateTitle: { color: "#5E6D6B", fontSize: 11, fontFamily: typo.title.family },
  emptyDateAction: {
    color: "#0B9888",
    fontSize: 11,
    fontFamily: typo.label.family,
  ...
  homeMetricLabel: { color: "#AAB4C7", fontSize: 11, fontFamily: typo.label.family },
  homeQuick: {
    flex: 1,
    height: 72,
    borderRadius: 16,
  ...
  homeQuickIconText: { fontSize: 15, fontFamily: typo.label.family },
  homeQuickLabel: { color: "#414A59", fontSize: 13, fontFamily: typo.label.family },
  homeQuickLabelEmbedded: { fontSize: 11, fontFamily: typo.label.family },
  homeQuickLabelLarge: { fontSize: 16, fontFamily: typo.label.family },
  homeQuickLabelRail: { fontSize: 11, fontFamily: typo.label.family },
  ...
  searchCategoryText: { color: "#747A80", fontSize: 11, fontFamily: typo.label.family },
  ...
  searchResultCount: { color: "#8C939B", fontSize: 11, fontFamily: typo.data.family },
  searchResultLine: { flexDirection: "row", alignItems: "center", gap: 6 },
  searchResultName: { color: "#273143", fontSize: 13, fontFamily: typo.title.family },
  searchResultType: { fontSize: 11, fontFamily: typo.label.family },
  searchResultDetail: { color: "#747D88", fontSize: 11, marginTop: 4 },
  searchResultTrip: { color: "#A0A5AB", fontSize: 11, marginTop: 2 },
  searchResultArrow: { color: "#9AA1A8", fontSize: 20 },
  searchEmptyTitle: { color: "#394353", fontSize: 14, fontFamily: typo.title.family },
  ...
  rangeSummaryLabel: { color: "#5ED8C9", fontSize: 11, fontFamily: typo.label.family },
  rangeSummaryValue: {
    color: "#FFFFFF",
    fontSize: 12,
  ...
  rangeNightsText: { color: "#FFFFFF", fontSize: 11, fontFamily: typo.data.family },
  rangeCalendar: {
    marginTop: 8,
    borderRadius: 16,
    paddingHorizontal: 12,
  ...
  rangeMonthTitle: { color: "#17233D", fontSize: 13, fontFamily: typo.title.family },
  ...
  tripNote: { fontSize: 11, marginTop: 2 },
  ...
  noTripsTitle: { fontSize: 14, fontFamily: typo.title.family, marginTop: 8 },
  noTripsText: { fontSize: 11, textAlign: "center", marginTop: 4 },
  emptyInlineAction: {
    borderRadius: 8,
    paddingHorizontal: 12,
    paddingVertical: 8,
  ...
  emptyInlineActionText: { fontSize: 11, fontFamily: typo.label.family },
  calendarCard: {
    borderRadius: 8,
    paddingHorizontal: 12,
    paddingTop: 20,
  ...
  calendarTodayText: { color: "#596071", fontSize: 10, fontFamily: typo.label.family },
  monthArrowText: { color: "#384052", fontSize: 25, fontWeight: "500", lineHeight: 27 },
  calendarMonth: { color: "#283046", fontSize: 19, fontFamily: typo.data.family, textAlign: "left", letterSpacing: 0.2 },
  ...
  calendarLegendText: { color: "#6F716F", fontSize: 10, fontFamily: typo.label.family },
  ...
  weekName: { width: "14.285%", textAlign: "center", color: "#85888D", fontSize: 10, fontFamily: typo.title.family },
  ...
  dayNumber: { color: "#424957", fontSize: 11, fontFamily: typo.data.family },
  dayNumberBadge: {
    width: 21,
    height: 21,
    borderRadius: 12,
  ...
  searchCategoryCountText: { fontSize: 10, fontFamily: typo.data.family },
  searchGuideHead: {
    height: 26,
    flexDirection: "row",
    alignItems: "center",
  ...
  searchSuggestionText: { fontSize: 11, fontFamily: typo.label.family },
  searchSuggestionRemove: { fontSize: 15, lineHeight: 18, fontFamily: typo.label.family },
  searchRecentClear: { fontSize: 10, fontFamily: typo.label.family },
  searchRecentEmpty: { fontSize: 11, paddingVertical: 6 },
  searchResultsSheet: {
    gap: 8,
  },
  searchResultCard: {
  ...
  searchResultTag: { fontSize: 11, fontFamily: typo.label.family },
  searchResultActions: {
    height: 39,
    flexDirection: "row",
    borderTopWidth: StyleSheet.hairlineWidth,
  ...
  searchResultActionText: { fontSize: 11, fontFamily: typo.label.family },
  searchEmpty: {
    minHeight: 190,
    borderWidth: 1,
    borderStyle: "dashed",
  ...
  searchInputNew: { flex: 1, fontSize: 13, marginLeft: 8 },
  ...
  historyEyebrow: { fontSize: 11, fontFamily: typo.label.family, letterSpacing: 0.5 },
  historyTitle: { fontSize: 15, fontFamily: typo.title.family, marginTop: 4 },
  historyPeriod: { fontSize: 11, fontFamily: typo.label.family },
  historyUnit: { fontSize: 11, fontFamily: typo.label.family },
  ...
  togetherQuickIconText: { fontSize: 11, fontFamily: typo.label.family },
  togetherQuickLabel: { maxWidth: "100%", fontSize: 11, fontFamily: typo.label.family },
  memberRoleText: { fontSize: 11, fontFamily: typo.label.family, marginTop: -7 },
  memberPermissionLabel: { fontSize: 11, fontFamily: typo.label.family, marginBottom: 8 },
  profileSheetPreview: {
    minHeight: 86,
    borderRadius: 12,
    flexDirection: "row",
  ...
  profileSheetName: { flex: 1, fontSize: 13, fontFamily: typo.title.family, marginLeft: 12 },
  settingGroup: {
    borderRadius: 8,
    paddingHorizontal: 16,
    borderWidth: 1,
  ...
  authLogo: { fontSize: 30, fontFamily: typo.hero.family, letterSpacing: -1 },
  ...
  authDescription: { fontSize: 11, lineHeight: 17, marginTop: 6, marginBottom: 20 },
  ...
  oauthLabel: { fontSize: 11, fontFamily: typo.label.family },
  authDivider: { flexDirection: "row", alignItems: "center", marginVertical: 16 },
  authDividerLine: { flex: 1, height: 1 },
  authDividerText: { fontSize: 11, fontFamily: typo.label.family, marginHorizontal: 8 },
  authError: { color: "#DF5148", fontSize: 11, fontFamily: typo.label.family, marginTop: 2 },
  authSubmit: {
    height: 52,
    borderRadius: 12,
    alignItems: "center",
  ...
  authSwitchText: { fontSize: 11, fontFamily: typo.label.family },
  ...
  authConsentText: { flex: 1, fontSize: 11, fontFamily: typo.label.family },
  authPrivacy: { fontSize: 11, lineHeight: 13, textAlign: "center", marginTop: 16 },
  accountPreview: {
    minHeight: 82,
    borderRadius: 12,
    flexDirection: "row",
  ...
  accountAvatarText: { color: "#FFFFFF", fontSize: 17, fontFamily: typo.label.family },
  accountPreviewCopy: { flex: 1, marginLeft: 12 },
  accountPreviewName: { fontSize: 14, fontFamily: typo.title.family },
  accountPreviewEmail: { fontSize: 11, fontFamily: typo.label.family, marginTop: 4 },
  accountLogout: {
    height: 46,
    borderRadius: 8,
    borderWidth: 1,
  ...
  accountLogoutText: { color: "#DF5148", fontSize: 11, fontFamily: typo.label.family },
  accountDelete: { minHeight: 40, alignItems: "center", justifyContent: "center", marginTop: 4 },
  accountDeleteText: { color: "#A36E67", fontSize: 11, fontFamily: typo.label.family, textDecorationLine: "underline" },
  groupChoice: {
    minHeight: 66,
    borderRadius: 12,
    borderWidth: 1,
  ...
  groupChoiceAvatarText: { fontSize: 13, fontFamily: typo.label.family },
  groupChoiceCopy: { flex: 1, marginLeft: 12 },
  groupChoiceName: { fontSize: 12, fontFamily: typo.title.family },
  groupChoiceMeta: { fontSize: 11, fontFamily: typo.caption.family, marginTop: 4 },
  groupChoiceCheck: { width: 18, fontSize: 13, fontFamily: typo.label.family, textAlign: "center" },
  togetherAccountButton: { width: 38, height: 38, borderRadius: 12, alignItems: "center", justifyContent: "center" },
  togetherAccountInitial: { fontSize: 13, fontFamily: typo.label.family },
  workspaceCard: {
    minHeight: 86,
    borderRadius: 12,
    borderWidth: 1,
  ...
  workspaceLabel: { fontSize: 11, fontFamily: typo.label.family },
  ...
  workspaceSwitchBadgeText: { fontSize: 11, fontFamily: typo.label.family },
  groupTabs: {
    flexDirection: "row",
    gap: 6,
    marginTop: 8,
  ...
  groupTabText: { fontSize: 11, fontFamily: typo.label.family },
  groupTabMore: {
    width: 34,
    height: 32,
    alignItems: "center",
  ...
  groupTabMoreText: { fontSize: 11, fontFamily: typo.label.family, letterSpacing: 1 },
  memberSectionHead: { flexDirection: "row", alignItems: "flex-end", justifyContent: "space-between", marginTop: 16, marginBottom: 8 },
  memberSectionTitle: { fontSize: 14, fontFamily: typo.title.family, marginTop: 2 },
  memberManageText: { fontSize: 11, fontFamily: typo.label.family, paddingVertical: 4 },
  ...
  memberStripInitial: { color: "#FFFFFF", fontSize: 13, fontFamily: typo.label.family },
  memberStripName: { width: "100%", textAlign: "center", fontSize: 11, fontFamily: typo.title.family, marginTop: 6 },
  memberStripRole: {
    width: "100%",
    textAlign: "center",
    fontSize: 10,
  ...
  memberInvitePlus: { fontSize: 17, fontFamily: typo.label.family },
  managementLabel: { fontSize: 11, fontFamily: typo.label.family, marginTop: 16, marginBottom: -2 },
  ...
  historySummaryLabel: { fontSize: 11, fontFamily: typo.label.family, marginTop: 4 },
  historyLatest: {
    minHeight: 43,
    borderBottomWidth: 1,
    flexDirection: "row",
  ...
  historyLatestLabel: { fontSize: 11, fontFamily: typo.label.family },
  historyLatestName: { flex: 1, fontSize: 11, fontFamily: typo.title.family },
  historyLatestDate: { fontSize: 10, fontFamily: typo.caption.family },
  memberManagerHead: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginBottom: 12 },
  memberManagerTitle: { fontSize: 14, fontFamily: typo.title.family },
  memberManagerCopy: { fontSize: 11, fontFamily: typo.body.family, marginTop: 4 },
  memberManagerInvite: { height: 34, borderRadius: 8, paddingHorizontal: 12, alignItems: "center", justifyContent: "center" },
  memberManagerInviteText: { fontSize: 11, fontFamily: typo.label.family },
  ...
  memberManagerName: { fontSize: 11, fontFamily: typo.title.family },
  memberManagerRole: { fontSize: 11, fontFamily: typo.label.family, marginTop: 2 },
  memberEditor: { borderRadius: 12, padding: 12 },
  memberEditorEyebrow: { fontSize: 11, fontFamily: typo.label.family, marginBottom: 8 },
  memberRemoveButton: { height: 38, alignItems: "center", justifyContent: "center", marginTop: 4 },
  memberRemoveText: { color: "#DF5148", fontSize: 11, fontFamily: typo.label.family },
});
