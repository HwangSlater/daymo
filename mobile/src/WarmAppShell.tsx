...
const s = StyleSheet.create({
  ...
  artText: { color: "#623C38", fontSize: 13, fontWeight: typo.label.weight },
  artLine: { width: 25, height: 2, backgroundColor: "#623C38", marginTop: 5 },
  newTripText: { color: "#FFF9F4", fontSize: 11, fontWeight: typo.label.weight },
  ...
  settingName: { color: "#6A4941", fontSize: 14, fontWeight: typo.title.weight },
  settingRight: { flexDirection: "row", alignItems: "center", gap: 8 },
  settingValue: { color: "#B46F60", fontSize: 11, fontWeight: typo.data.weight },
  ...
  notebookHello: { fontSize: 11, marginTop: 3, fontWeight: typo.body.weight },
  tinyDay: {
  ...
  tinyDayText: { fontSize: 11, fontWeight: typo.data.weight },
  paperTripStack: {
    position: "relative",
    marginBottom: 3,
  },
  ...
  paperKicker: { fontSize: 11, fontWeight: typo.label.weight, marginBottom: 7 },
  paperTitle: { fontSize: 28, fontWeight: typo.title.weight, letterSpacing: -1.3 },
  ...
  paperTripStampMonth: { fontSize: 11, fontWeight: typo.data.weight, letterSpacing: 0.8 },
  paperTripStampDay: { fontSize: 20, lineHeight: 23, fontWeight: typo.data.weight },
  ...
  paperStayLabel: { fontSize: 11, fontWeight: typo.label.weight },
  paperStayName: { fontSize: 13, fontWeight: typo.title.weight, marginTop: 3 },
  paperStayTime: {
    minWidth: 58,
    minHeight: 40,
    borderRadius: 11,
  ...
  paperStayTimeLabel: { fontSize: 11, fontWeight: typo.label.weight },
  paperStayTimeValue: { fontSize: 12, fontWeight: typo.data.weight, marginTop: 1 },
  paperTripActions: {
    flexDirection: "row",
    marginTop: 14,
    marginHorizontal: -19,
  ...
  paperTripActionLabel: { fontSize: 11, fontWeight: typo.label.weight, letterSpacing: -0.2 },
  paperTripActionMeta: { color: "#756F63", fontSize: 10, fontWeight: typo.caption.weight, marginTop: 3 },
  ...
  noteTitleSmall: { fontSize: 11, fontWeight: typo.label.weight, marginBottom: 4 },
  noteTitle: { fontSize: 20, fontWeight: typo.title.weight, letterSpacing: -0.6 },
  memoPaper: {
    marginTop: 0,
    borderWidth: 1,
    borderRadius: 8,
  ...
  memoText: { fontSize: 12, fontWeight: typo.body.weight },
  ...
  homeArchiveEyebrow: { fontSize: 11, fontWeight: typo.label.weight, marginBottom: 4 },
  homeArchiveTitle: { fontSize: 18, fontWeight: typo.title.weight, letterSpacing: -0.5 },
  homeArchiveMore: { fontSize: 11, fontWeight: typo.label.weight },
  ...
  homeArchiveDate: { fontSize: 11, fontWeight: typo.caption.weight },
  homeArchivePlace: { fontSize: 15, fontWeight: typo.label.weight, marginTop: 5 },
  homeArchiveNote: { fontSize: 11, lineHeight: 15, marginTop: 5 },
  homeArchiveAction: { fontSize: 11, fontWeight: typo.label.weight, marginTop: "auto", paddingTop: 8 },
  homeEmptyTrip: {
    minHeight: 250,
    borderRadius: 8,
    borderWidth: 1,
  ...
  homeEmptyTripMarkText: { fontSize: 22, fontWeight: typo.label.weight },
  homeEmptyTripTitle: { fontSize: 17, fontWeight: typo.title.weight, textAlign: "center" },
  homeEmptyTripCopy: {
    maxWidth: 270,
    fontSize: 11,
    lineHeight: 17,
  ...
  homeEmptyTripActionText: { color: "#FFFFFF", fontSize: 12, fontWeight: typo.label.weight },
  safe: {
    flex: 1,
    width: "100%",
    maxWidth: 430,
  ...
  infoSheetDoneText: { fontSize: 13, lineHeight: 17, fontWeight: typo.label.weight },
  ...
  choiceText: { color: "#576173", fontSize: 14, fontWeight: typo.label.weight },
  choiceTextSelected: { color: "#5546C8" },
  choiceMark: { color: "#6556D8", fontSize: 16, fontWeight: typo.label.weight },
  tripExplorerPage: {
  ...
  viewChoiceText: { color: "#858783", fontSize: 13, fontWeight: typo.label.weight },
  ...
  mapTrayTitle: { color: "#17233D", fontSize: 15, fontWeight: typo.title.weight },
  ...
  mapTrayMarkText: { color: "#FFFFFF", fontSize: 11, fontWeight: typo.label.weight },
  mapTrayCopy: { flex: 1, paddingHorizontal: 10 },
  mapTrayName: { color: "#17233D", fontSize: 12, fontWeight: typo.title.weight },
  ...
  pinCountText: { color: "#17233D", fontSize: 11, fontWeight: typo.data.weight },
  zoomControls: {
    position: "absolute",
    right: 5,
    bottom: 14,
  ...
  zoomText: { color: "#17233D", fontSize: 19, fontWeight: typo.title.weight },
  zoomResetText: { fontSize: 10, fontWeight: typo.label.weight },
  ...
  dayNumberTrip: { color: "#FFFFFF", fontWeight: typo.label.weight },
  ...
  calendarResultClear: { fontSize: 10, fontWeight: typo.label.weight },
  emptyDateTitle: { color: "#5E6D6B", fontSize: 11, fontWeight: typo.title.weight },
  emptyDateAction: {
    color: "#0B9888",
    fontSize: 11,
    fontWeight: typo.label.weight,
  ...
  regionChoiceText: { color: "#7E8388", fontSize: 12, fontWeight: typo.label.weight },
  ...
  homeMetricValue: { fontSize: 18, fontWeight: typo.data.weight },
  homeMetricLabel: { color: "#AAB4C7", fontSize: 11, fontWeight: typo.label.weight },
  homeQuick: {
    flex: 1,
    height: 72,
    borderRadius: 18,
  ...
  homeQuickIconText: { fontSize: 15, fontWeight: typo.label.weight },
  homeQuickLabel: { color: "#414A59", fontSize: 13, fontWeight: typo.label.weight },
  homeQuickLabelEmbedded: { fontSize: 11, fontWeight: typo.label.weight },
  homeQuickLabelLarge: { fontSize: 16, fontWeight: typo.label.weight },
  homeQuickLabelRail: { fontSize: 11, fontWeight: typo.label.weight },
  ...
  searchCategoryText: { color: "#747A80", fontSize: 11, fontWeight: typo.label.weight },
  ...
  searchResultTitle: { color: "#17233D", fontSize: 16, fontWeight: typo.title.weight },
  searchResultCount: { color: "#8C939B", fontSize: 11, fontWeight: typo.data.weight },
  searchResultLine: { flexDirection: "row", alignItems: "center", gap: 7 },
  searchResultName: { color: "#273143", fontSize: 13, fontWeight: typo.title.weight },
  searchResultType: { fontSize: 11, fontWeight: typo.label.weight },
  ...
  searchEmptyTitle: { color: "#394353", fontSize: 14, fontWeight: typo.title.weight },
  ...
  togetherAvatarText: { color: "#FFFFFF", fontSize: 12, fontWeight: typo.label.weight },
  settingGroupLabel: {
    color: "#7A818C",
    fontSize: 11,
    fontWeight: typo.label.weight,
  ...
  rangeSummaryLabel: { color: "#5ED8C9", fontSize: 11, fontWeight: typo.label.weight },
  rangeSummaryValue: {
    color: "#FFFFFF",
    fontSize: 12,
  ...
  rangeNightsText: { color: "#FFFFFF", fontSize: 11, fontWeight: typo.data.weight },
  rangeCalendar: {
    marginTop: 8,
    borderRadius: 18,
    paddingHorizontal: 12,
  ...
  rangeMonthTitle: { color: "#17233D", fontSize: 13, fontWeight: typo.title.weight },
  ...
  rangeDayTextActive: { color: "#087D70", fontWeight: typo.label.weight },
  ...
  tripName: { fontSize: 14, fontWeight: typo.title.weight },
  ...
  tripRowArrowText: { fontSize: 18, lineHeight: 19, fontWeight: typo.label.weight },
  noTrips: {
    minHeight: 190,
    borderRadius: 18,
    borderWidth: 1,
  ...
  noTripsTitle: { fontSize: 14, fontWeight: typo.title.weight, marginTop: 10 },
  ...
  emptyInlineActionText: { fontSize: 11, fontWeight: typo.label.weight },
  calendarCard: {
    borderRadius: 7,
    paddingHorizontal: 13,
    paddingTop: 21,
  ...
  calendarTodayText: { color: "#596071", fontSize: 10, fontWeight: typo.label.weight },
  monthArrowText: { color: "#384052", fontSize: 25, fontWeight: "500", lineHeight: 27 },
  calendarMonth: { color: "#283046", fontSize: 19, fontWeight: typo.data.weight, textAlign: "left", letterSpacing: 0.2 },
  ...
  calendarLegendText: { color: "#6F716F", fontSize: 10, fontWeight: typo.label.weight },
  ...
  weekName: { width: "14.285%", textAlign: "center", color: "#85888D", fontSize: 10, fontWeight: typo.title.weight },
  ...
  dayNumber: { color: "#424957", fontSize: 11, fontWeight: typo.data.weight },
  dayNumberBadge: {
    width: 21,
    height: 21,
    borderRadius: 11,
  ...
  searchCategoryCountText: { fontSize: 10, fontWeight: typo.data.weight },
  searchGuideHead: {
    height: 26,
    flexDirection: "row",
    alignItems: "center",
  ...
  searchSuggestionText: { fontSize: 11, fontWeight: typo.label.weight },
  searchSuggestionRemove: { fontSize: 15, lineHeight: 18, fontWeight: typo.label.weight },
  searchRecentClear: { fontSize: 10, fontWeight: typo.label.weight },
  ...
  searchResultTag: { fontSize: 11, fontWeight: typo.label.weight },
  searchResultActions: {
    height: 39,
    flexDirection: "row",
    borderTopWidth: StyleSheet.hairlineWidth,
  ...
  searchResultActionText: { fontSize: 11, fontWeight: typo.label.weight },
  searchEmpty: {
    minHeight: 190,
    borderWidth: 1,
    borderStyle: "dashed",
  ...
  historyEyebrow: { fontSize: 11, fontWeight: typo.label.weight, letterSpacing: 0.5 },
  historyTitle: { fontSize: 15, fontWeight: typo.title.weight, marginTop: 4 },
  historyPeriod: { fontSize: 11, fontWeight: typo.label.weight },
  historyUnit: { fontSize: 11, fontWeight: typo.label.weight },
  ...
  togetherQuickIconText: { fontSize: 11, fontWeight: typo.label.weight },
  togetherQuickLabel: { maxWidth: "100%", fontSize: 11, fontWeight: typo.label.weight },
  memberRoleText: { fontSize: 11, fontWeight: typo.label.weight, marginTop: -7 },
  memberPermissionLabel: { fontSize: 11, fontWeight: typo.label.weight, marginBottom: 8 },
  profileSheetPreview: {
    minHeight: 86,
    borderRadius: 12,
    flexDirection: "row",
  ...
  profileSheetName: { flex: 1, fontSize: 13, fontWeight: typo.title.weight, marginLeft: 12 },
  settingGroup: {
    borderRadius: 10,
    paddingHorizontal: 15,
    borderWidth: 1,
  ...
  navText: { fontSize: 12, fontWeight: typo.label.weight },
  ...
  authLogo: { fontSize: 30, fontWeight: typo.hero.weight, letterSpacing: -1 },
  authTagline: { fontSize: 11, fontWeight: typo.caption.weight, marginTop: 6 },
  authCard: { borderRadius: 18, borderWidth: 1, padding: 20 },
  authTitle: { fontSize: 20, fontWeight: typo.title.weight, letterSpacing: -0.5 },
  ...
  oauthMark: { fontSize: 12, fontWeight: typo.label.weight, marginRight: 7 },
  oauthLabel: { fontSize: 11, fontWeight: typo.label.weight },
  authDivider: { flexDirection: "row", alignItems: "center", marginVertical: 18 },
  authDividerLine: { flex: 1, height: 1 },
  authDividerText: { fontSize: 11, fontWeight: typo.label.weight, marginHorizontal: 10 },
  authError: { color: "#DF5148", fontSize: 11, fontWeight: typo.label.weight, marginTop: 2 },
  authSubmit: {
    height: 52,
    borderRadius: 12,
    alignItems: "center",
  ...
  authSubmitText: { color: "#FFFFFF", fontSize: 14, fontWeight: typo.label.weight },
  authSwitch: { alignItems: "center", paddingTop: 17, paddingBottom: 2 },
  authSwitchText: { fontSize: 11, fontWeight: typo.label.weight },
  ...
  authConsentAllText: { flex: 1, fontSize: 12, fontWeight: typo.label.weight },
  authConsentCheck: { width: 22, height: 22, borderRadius: 7, borderWidth: 1, alignItems: "center", justifyContent: "center", marginRight: 10 },
  authConsentTick: { color: "#FFFFFF", fontSize: 12, fontWeight: typo.label.weight },
  authConsentText: { flex: 1, fontSize: 11, fontWeight: typo.label.weight },
  ...
  accountAvatarText: { color: "#FFFFFF", fontSize: 17, fontWeight: typo.label.weight },
  accountPreviewCopy: { flex: 1, marginLeft: 12 },
  accountPreviewName: { fontSize: 14, fontWeight: typo.title.weight },
  accountPreviewEmail: { fontSize: 11, fontWeight: typo.label.weight, marginTop: 4 },
  accountLogout: {
    height: 46,
    borderRadius: 10,
    borderWidth: 1,
  ...
  accountLogoutText: { color: "#DF5148", fontSize: 11, fontWeight: typo.label.weight },
  accountDelete: { minHeight: 40, alignItems: "center", justifyContent: "center", marginTop: 5 },
  accountDeleteText: { color: "#A36E67", fontSize: 11, fontWeight: typo.label.weight, textDecorationLine: "underline" },
  groupChoice: {
    minHeight: 66,
    borderRadius: 12,
    borderWidth: 1,
  ...
  groupChoiceAvatarText: { fontSize: 13, fontWeight: typo.label.weight },
  groupChoiceCopy: { flex: 1, marginLeft: 11 },
  groupChoiceName: { fontSize: 12, fontWeight: typo.title.weight },
  groupChoiceMeta: { fontSize: 11, fontWeight: typo.caption.weight, marginTop: 4 },
  groupChoiceCheck: { width: 18, fontSize: 13, fontWeight: typo.label.weight, textAlign: "center" },
  togetherAccountButton: { width: 38, height: 38, borderRadius: 13, alignItems: "center", justifyContent: "center" },
  togetherAccountInitial: { fontSize: 13, fontWeight: typo.label.weight },
  workspaceCard: {
    minHeight: 86,
    borderRadius: 13,
    borderWidth: 1,
  ...
  workspaceLabel: { fontSize: 11, fontWeight: typo.label.weight },
  workspaceName: { fontSize: 14, fontWeight: typo.title.weight, marginTop: 3 },
  workspaceMeta: { fontSize: 11, fontWeight: typo.caption.weight, marginTop: 4 },
  workspaceSwitchBadge: { height: 29, borderRadius: 9, paddingHorizontal: 9, alignItems: "center", justifyContent: "center" },
  workspaceSwitchBadgeText: { fontSize: 11, fontWeight: typo.label.weight },
  groupTabs: {
    flexDirection: "row",
    gap: 6,
    marginTop: 8,
  ...
  groupTabText: { fontSize: 11, fontWeight: typo.label.weight },
  groupTabMore: {
    width: 34,
    height: 32,
    alignItems: "center",
  ...
  groupTabMoreText: { fontSize: 11, fontWeight: typo.label.weight, letterSpacing: 1 },
  memberSectionHead: { flexDirection: "row", alignItems: "flex-end", justifyContent: "space-between", marginTop: 18, marginBottom: 8 },
  memberSectionTitle: { fontSize: 14, fontWeight: typo.title.weight, marginTop: 3 },
  memberManageText: { fontSize: 11, fontWeight: typo.label.weight, paddingVertical: 5 },
  ...
  memberStripInitial: { color: "#FFFFFF", fontSize: 13, fontWeight: typo.label.weight },
  memberStripName: { width: "100%", textAlign: "center", fontSize: 11, fontWeight: typo.title.weight, marginTop: 6 },
  memberStripRole: {
    width: "100%",
    textAlign: "center",
    fontSize: 10,
  ...
  memberInvitePlus: { fontSize: 17, fontWeight: typo.label.weight },
  managementLabel: { fontSize: 11, fontWeight: typo.label.weight, marginTop: 15, marginBottom: -2 },
  ...
  historySummaryValue: { fontSize: 16, fontWeight: typo.data.weight },
  historySummaryLabel: { fontSize: 11, fontWeight: typo.label.weight, marginTop: 4 },
  historyLatest: {
    minHeight: 43,
    borderBottomWidth: 1,
    flexDirection: "row",
  ...
  historyLatestLabel: { fontSize: 11, fontWeight: typo.label.weight },
  historyLatestName: { flex: 1, fontSize: 11, fontWeight: typo.title.weight },
  historyLatestDate: { fontSize: 10, fontWeight: typo.caption.weight },
  memberManagerHead: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginBottom: 13 },
  memberManagerTitle: { fontSize: 14, fontWeight: typo.title.weight },
  memberManagerCopy: { fontSize: 11, fontWeight: typo.body.weight, marginTop: 4 },
  memberManagerInvite: { height: 34, borderRadius: 10, paddingHorizontal: 11, alignItems: "center", justifyContent: "center" },
  memberManagerInviteText: { fontSize: 11, fontWeight: typo.label.weight },
  ...
  memberManagerName: { fontSize: 11, fontWeight: typo.title.weight },
  memberManagerRole: { fontSize: 11, fontWeight: typo.label.weight, marginTop: 3 },
  memberEditor: { borderRadius: 13, padding: 14 },
  memberEditorEyebrow: { fontSize: 11, fontWeight: typo.label.weight, marginBottom: 9 },
  memberRemoveButton: { height: 38, alignItems: "center", justifyContent: "center", marginTop: 5 },
  memberRemoveText: { color: "#DF5148", fontSize: 11, fontWeight: typo.label.weight },
});
