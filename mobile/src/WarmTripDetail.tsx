...
import { legacyIdMap, placeCodec, safeUrl, UNKNOWN_AREA } from "./placeSync";
...
import { CoverBadge, DetailEditableContext, DetailFeedbackContext, DetailField, DetailSheet, DetailThemeContext, EmptyState, FeedbackAction, ListMoreButton, MoneyBlock, NO_IDS, NO_PHOTOS, OptionField, OptionalFormSection, PhotoStrip, ReportForm, ReportLink, SectionLabel, StayRangePicker, TabActionHeader, TimeRow, ViewMode, newPlaceId, readClipboard, requiredDot, useDraftChanged, useOrderWarning, 금액_치기, 금액_키보드, 붙여넣기_한도 } from "./trip/parts";
