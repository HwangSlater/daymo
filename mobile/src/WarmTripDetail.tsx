...
const styles = StyleSheet.create({
  ...
  feedbackToastText: { flex: 1, color: "#FFFFFF", fontSize: 13, fontWeight: typo.label.weight },
  ...
  tripMemoEdit: { color: "#746F6A", fontSize: 11, fontWeight: typo.label.weight },
  tripMemoDelete: { color: "#D05E58", fontSize: 11, fontWeight: typo.label.weight },
  tripMemoAuthor: { color: "#B76A59", fontSize: 11, fontWeight: typo.label.weight },
  ...
  memoAddCopy: { flex: 1 },
  memoAddTitle: { fontSize: 13, fontWeight: typo.title.weight },
  ...
  memoEditorTitle: { fontSize: 13, fontWeight: typo.title.weight },
  memoEditorCancel: { fontSize: 11, fontWeight: typo.label.weight },
  memoEmpty: { alignItems: "center", paddingVertical: 22 },
  memoEmptyTitle: { fontSize: 13, fontWeight: typo.title.weight },
  ...
  transportOwner: { fontSize: 11, fontWeight: typo.label.weight },
  transportStatus: { fontSize: 11, fontWeight: typo.label.weight },
  transportMethod: { fontSize: 11, fontWeight: typo.label.weight, marginTop: 6 },
  ...
  transportPlace: { fontSize: 11, fontWeight: typo.label.weight },
  transportTime: { fontSize: 11, fontWeight: typo.caption.weight, marginTop: 2 },
  ...
  transportRouteArrow: { fontSize: 12, lineHeight: 13, fontWeight: typo.label.weight },
  transportReturn: { fontSize: 11, fontWeight: typo.label.weight, marginTop: 8 },
  transportFormPreview: { borderWidth: 1, borderRadius: 12, padding: 13, marginBottom: 16 },
  transportFormOwner: { fontSize: 11, fontWeight: typo.label.weight },
  transportPreviewRouteRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginTop: 6 },
  transportFormRoute: { flex: 1, minWidth: 0, fontSize: 16, fontWeight: typo.label.weight },
  transportFormMeta: { fontSize: 11, fontWeight: typo.caption.weight, marginTop: 4 },
  transportSwitchHint: { flexDirection: "row", alignItems: "center", justifyContent: "space-between" },
  transportSwitchHintText: { fontSize: 11, lineHeight: 13, fontWeight: typo.caption.weight },
  transportSwitchHintArrow: { fontSize: 13, lineHeight: 15, fontWeight: typo.label.weight },
  ...
  pairedFieldArrowText: { fontSize: 13, lineHeight: 15, fontWeight: typo.label.weight },
  transportDetailBlock: { borderBottomWidth: 1, paddingBottom: 9, marginBottom: 9 },
  transportDetailDirection: { fontSize: 11, fontWeight: typo.label.weight, marginBottom: 3 },
  infoManageButton: { minHeight: 34, borderRadius: 9, alignItems: "center", justifyContent: "center", marginTop: 7 },
  infoManageButtonText: { fontSize: 11, fontWeight: typo.label.weight },
  ...
  travelMiniMarkText: { fontSize: 11, fontWeight: typo.label.weight },
  travelMiniLabel: { fontSize: 11, fontWeight: typo.label.weight, letterSpacing: 0.5 },
  travelMiniTitle: { fontSize: 13, fontWeight: typo.title.weight, marginTop: 7 },
  travelMiniBottom: {
    flexDirection: "row",
    alignItems: "center",
    justifyContent: "space-between",
  ...
  travelMiniMeta: { flex: 1, fontSize: 11, fontWeight: typo.caption.weight },
  travelMiniArrow: { fontSize: 16, lineHeight: 17, fontWeight: typo.label.weight, marginLeft: 4 },
  travelInfoRow: {
    minHeight: 62,
    borderWidth: 1,
    borderRadius: 12,
  ...
  travelInfoMark: { fontSize: 12, lineHeight: 15, fontWeight: typo.label.weight },
  travelInfoLabelText: { fontSize: 11, fontWeight: typo.label.weight, marginTop: 1 },
  travelInfoCopy: { flex: 1, minWidth: 0 },
  travelInfoTitle: { fontSize: 12, fontWeight: typo.title.weight },
  travelInfoMeta: { fontSize: 11, fontWeight: typo.caption.weight, marginTop: 3 },
  travelInfoArrowBox: {
    width: 27,
    height: 27,
    borderRadius: 9,
  ...
  travelInfoArrow: { fontSize: 17, lineHeight: 18, fontWeight: typo.label.weight },
  ...
  momentTitle: { color: "#5A3531", fontSize: 14, fontWeight: typo.title.weight },
  ...
  checkName: { color: "#593934", fontSize: 14, fontWeight: typo.title.weight },
  ...
  keepsakeStyle: { color: "#B06C5E", fontSize: 11, fontWeight: typo.label.weight },
  keepsakeTitle: { color: "#35333A", fontSize: 14, fontWeight: typo.title.weight, marginTop: 8 },
  ...
  diaryDate: { color: "#B06C5E", fontSize: 11, fontWeight: typo.caption.weight },
  diaryTitle: { color: "#35333A", fontSize: 13, fontWeight: typo.title.weight, marginTop: 7 },
  ...
  memoryTileDate: { fontSize: 11, fontWeight: typo.caption.weight },
  modalBack: {
    flex: 1,
  ...
  sheetKindText: { fontSize: 10, fontWeight: typo.label.weight, letterSpacing: 0.8 },
  ...
  infoPanelCloseText: { fontSize: 15, lineHeight: 19, fontWeight: typo.label.weight },
  ...
  stayPickerLabel: { fontSize: 13, fontWeight: typo.label.weight },
  stayPickerValue: { fontSize: 11, fontWeight: typo.data.weight },
  sheetSubmit: {
    height: 50,
    borderRadius: 17,
    backgroundColor: "#17233D",
  ...
  sheetSubmitText: { color: "#FFFFFF", fontSize: 14, fontWeight: typo.label.weight },
  ...
  sheetSubmitArrowText: { color: "#FFFFFF", fontSize: 18, fontWeight: typo.label.weight },
  infoLine: {
    minHeight: 58,
    borderBottomWidth: 1,
  ...
  infoLineLabel: { color: "#858D9A", fontSize: 11, fontWeight: typo.label.weight },
  infoLineValue: {
    color: "#17233D",
    fontSize: 13,
    fontWeight: typo.data.weight,
  ...
  tripMetaLabel: { color: "#6F7888", fontSize: 11, fontWeight: typo.label.weight },
  tripMetaValue: {
    color: "#17233D",
    fontSize: 13,
    fontWeight: typo.data.weight,
  ...
  optionText: { color: "#747D8D", fontSize: 11, fontWeight: typo.label.weight },
  ...
  previewDay: { color: "#DFFFFA", fontSize: 11, fontWeight: typo.data.weight },
  previewDateNo: {
    color: "#FFFFFF",
    fontSize: 23,
    lineHeight: 26,
  ...
  naverAutoFillTitle: { fontSize: 12, fontWeight: typo.title.weight },
  ...
  naverAutoFillButtonText: { color: "#16844E", fontSize: 11, fontWeight: typo.label.weight },
  naverLogo: {
    width: 30,
    height: 30,
    borderRadius: 9,
  ...
  naverLogoText: { color: "#FFFFFF", fontSize: 16, fontWeight: typo.label.weight },
  naverTitle: { color: "#184D36", fontSize: 12, fontWeight: typo.title.weight },
  ...
  linkState: { color: "#278153", fontSize: 11, fontWeight: typo.label.weight, marginTop: 8 },
  mapLink: {
  ...
  mapLinkIconText: { color: "#FFFFFF", fontSize: 11, fontWeight: typo.label.weight },
  mapLinkText: { color: "#23714B", fontSize: 11, fontWeight: typo.label.weight },
  mapLinkArrow: { color: "#23714B", fontSize: 11, marginLeft: 4 },
  placeFilterText: { color: "#7C8390", fontSize: 11, fontWeight: typo.label.weight },
  placeFilterTextActive: { color: "#FFFFFF" },
  placeAddText: { color: "#6556D8", fontSize: 11, fontWeight: typo.label.weight },
  placeList: { gap: 8 },
  placeFormIntro: {
    minHeight: 34,
    flexDirection: "row",
  ...
  placeRequiredBadgeText: { fontSize: 11, fontWeight: typo.label.weight },
  placeFormText: {
    color: "#61598C",
    fontSize: 11,
    fontWeight: typo.label.weight,
  ...
  resultCountText: { color: "#6556D8", fontSize: 11, fontWeight: typo.data.weight },
  tagFilterChipActive: { backgroundColor: "#8B7CF6" },
  tagFilterLabel: { color: "#777F8C", fontSize: 11, fontWeight: typo.label.weight },
  tagFilterLabelActive: { color: "#FFFFFF" },
  placeTags: { flexDirection: "row", flexWrap: "wrap", gap: 5, marginTop: 9 },
  placeTagText: { color: "#6556D8", fontSize: 11, fontWeight: typo.label.weight },
  tagEditor: { marginBottom: 18 },
  selectorLabel: { marginBottom: 9 },
  placeRecommendLabel: { fontSize: 11, fontWeight: typo.label.weight, marginBottom: 7 },
  tagSuggestions: {
    flexDirection: "row",
    flexWrap: "wrap",
    gap: 6,
  ...
  tagSuggestionText: { color: "#747C88", fontSize: 11, fontWeight: typo.label.weight },
  ...
  draftTagText: { color: "#6556D8", fontSize: 11, fontWeight: typo.label.weight },
  deletePlace: {
    height: 44,
    alignItems: "center",
    justifyContent: "center",
  ...
  deletePlaceText: { color: "#D6534A", fontSize: 11, fontWeight: typo.label.weight },
  fullScheduleText: { color: "#6556D8", fontSize: 11, fontWeight: typo.label.weight },
  ...
  planPlaceName: { color: "#17233D", fontSize: 18, fontWeight: typo.title.weight },
  planPlaceMeta: {
    color: "#7167A7",
    fontSize: 11,
    fontWeight: typo.caption.weight,
  ...
  packingManageTitle: { fontSize: 14, fontWeight: typo.title.weight },
  packingManageHint: { fontSize: 11, fontWeight: typo.caption.weight, marginTop: 3 },
  packingShowAll: {
    borderWidth: 1,
    borderRadius: 999,
    paddingHorizontal: 10,
  ...
  packingShowAllText: { fontSize: 11, fontWeight: typo.label.weight },
  ...
  ownerStatName: { color: "#17233D", fontSize: 11, fontWeight: typo.title.weight },
  ownerStatCount: {
    color: "#89909C",
    fontSize: 11,
    fontWeight: typo.data.weight,
  ...
  packingFilterLabel: { width: 38, fontSize: 11, fontWeight: typo.label.weight },
  ...
  packingFilterChipText: { fontSize: 11, fontWeight: typo.label.weight },
  packingFilterMore: {
    borderWidth: 1,
    borderRadius: 999,
    paddingHorizontal: 10,
  ...
  packingFilterMoreText: { fontSize: 11, fontWeight: typo.label.weight },
  ...
  packingOwnerAvatarText: { fontSize: 11, fontWeight: typo.label.weight },
  packingOwnerCopy: { flex: 1 },
  packingOwnerName: { fontSize: 15, fontWeight: typo.title.weight },
  packingOwnerProgress: { fontSize: 11, fontWeight: typo.label.weight, marginTop: 2 },
  packingCollapseIcon: {
    fontSize: 16,
    fontWeight: typo.label.weight,
    paddingHorizontal: 5,
  ...
  packingTagHeadText: { fontSize: 11, fontWeight: typo.label.weight },
  packingTagLine: {
    flex: 1,
    height: StyleSheet.hairlineWidth,
    marginHorizontal: 8,
  },
  packingTagCount: { fontSize: 11, fontWeight: typo.data.weight },
  ...
  completionTick: { color: "#FFFFFF", fontSize: 14, fontWeight: typo.label.weight },
  ...
  packingTiming: { fontSize: 11, fontWeight: typo.label.weight },
  packingOwnerChange: {
    borderRadius: 999,
    paddingHorizontal: 9,
    paddingVertical: 5,
  },
  packingOwnerChangeText: { fontSize: 11, fontWeight: typo.label.weight },
  ...
  packingSuitcaseStickerText: { fontSize: 11, fontWeight: typo.label.weight },
  packingSuitcaseFeet: {
    width: 24,
    flexDirection: "row",
    justifyContent: "space-between",
  ...
  packingJourneyTitle: { fontSize: 12, lineHeight: 17, fontWeight: typo.title.weight, marginTop: 1 },
  packingJourneyPercent: { width: 34, fontSize: 12, lineHeight: 16, fontWeight: typo.label.weight, textAlign: "right" },
  packingJourneyTrack: {
    flex: 1,
    height: 6,
    borderRadius: 999,
  ...
  packingV2TagButtonText: { fontSize: 11, fontWeight: typo.label.weight },
  packingV2TagChevron: { fontSize: 11, fontWeight: typo.label.weight, marginTop: -2 },
  ...
  packingV2OwnerName: { fontSize: 11, fontWeight: typo.title.weight },
  packingV2OwnerCount: { fontSize: 11, fontWeight: typo.data.weight },
  packingV2Group: {
    borderWidth: 1,
    borderRadius: 14,
    overflow: "hidden",
  ...
  packingV2GroupTitle: { fontSize: 13, fontWeight: typo.title.weight },
  packingV2GroupProgress: { fontSize: 11, fontWeight: typo.label.weight, marginTop: 2 },
  packingV2GroupCount: {
    borderRadius: 999,
    paddingHorizontal: 8,
    paddingVertical: 5,
  },
  packingV2GroupCountText: { fontSize: 11, fontWeight: typo.data.weight },
  packingV2Row: {
    minHeight: 49,
    paddingHorizontal: 12,
    flexDirection: "row",
  ...
  packingV2Quantity: { fontSize: 11, fontWeight: typo.data.weight },
  packingV2SubTags: { fontSize: 11, fontWeight: typo.label.weight, marginTop: 3 },
  packingV2Assignee: {
    minWidth: 38,
    borderRadius: 999,
    paddingHorizontal: 8,
  ...
  packingV2CompletedTitle: { fontSize: 11, fontWeight: typo.title.weight },
  packingV2CompletedToggle: { fontSize: 11, fontWeight: typo.label.weight },
  packingListTools: {
    borderTopWidth: 1,
    marginTop: 22,
    paddingTop: 14,
  ...
  packingListToolsTitle: { fontSize: 11, fontWeight: typo.title.weight },
  packingListToolsHint: { fontSize: 11, fontWeight: typo.caption.weight, marginTop: 3 },
  packingToolButton: {
    minWidth: 48,
    height: 34,
    borderWidth: 1,
  ...
  packingToolButtonText: { fontSize: 11, fontWeight: typo.label.weight },
  tagPickerGrid: {
    flexDirection: "row",
    flexWrap: "wrap",
    gap: 8,
  ...
  tagPickerName: { fontSize: 11, fontWeight: typo.title.weight, flex: 1 },
  tagPickerCount: { fontSize: 11, fontWeight: typo.data.weight },
  ...
  assignmentAvatarText: { fontSize: 11, fontWeight: typo.label.weight },
  assignmentCopy: { flex: 1 },
  assignmentName: { fontSize: 13, fontWeight: typo.title.weight },
  assignmentDescription: { fontSize: 11, fontWeight: typo.body.weight, marginTop: 3 },
  assignmentRadio: {
    width: 20,
    height: 20,
    borderRadius: 10,
  ...
  packingAssigneeOptionText: { fontSize: 11, fontWeight: typo.label.weight },
  ...
  cookingImportTitle: { color: "#35333A", fontSize: 11, fontWeight: typo.title.weight },
  cookingImportText: { color: "#8C8580", fontSize: 11, fontWeight: typo.label.weight, marginTop: 3 },
  cookingImportGroup: {
    borderRadius: 14,
    borderWidth: 1,
    borderColor: "#E5E3DD",
  ...
  cookingImportGroupTitle: { color: "#35333A", fontSize: 11, fontWeight: typo.title.weight },
  cookingImportGroupCount: { color: "#8C8580", fontSize: 11, fontWeight: typo.data.weight },
  cookingImportRow: {
    minHeight: 45,
    borderTopWidth: 1,
  ...
  cookingImportCheckText: { color: "#FFFFFF", fontSize: 11, fontWeight: typo.label.weight },
  cookingImportItemCopy: { flex: 1 },
  cookingImportItemName: { color: "#35333A", fontSize: 11, fontWeight: typo.title.weight },
  cookingImportItemMeta: { color: "#8C8580", fontSize: 11, fontWeight: typo.caption.weight, marginTop: 3 },
  packingQuantity: { color: "#858D99", fontSize: 11, fontWeight: typo.data.weight },
  settingHint: {
    color: "#7A7F89",
    fontSize: 11,
    lineHeight: 17,
  ...
  cookV2ProgressBadgeValue: { fontSize: 18, lineHeight: 22, fontWeight: typo.data.weight },
  cookV2ProgressBadgeLabel: { fontSize: 11, fontWeight: typo.label.weight, marginTop: 2 },
  ...
  recipeSelectorTitle: { color: "#777F8C", fontSize: 11, fontWeight: typo.title.weight },
  recipeSelectorActions: { flexDirection: "row", alignItems: "center", gap: 8 },
  recipeSelectorCount: { color: "#92909A", fontSize: 11, fontWeight: typo.data.weight },
  recipeSelectorMore: { color: "#D9685F", fontSize: 11, fontWeight: typo.label.weight },
  ...
  cookV2MenuNumber: { fontSize: 11, fontWeight: typo.data.weight, letterSpacing: 0.7 },
  cookV2MenuCount: { fontSize: 11, fontWeight: typo.data.weight },
  cookV2MenuName: { fontSize: 12, fontWeight: typo.title.weight },
  cookV2MenuNote: { fontSize: 11, fontWeight: typo.body.weight, marginTop: 4 },
  recipeList: {
    borderRadius: 14,
    borderWidth: 1,
    borderColor: "#E5DED6",
  ...
  recipeListNumberText: { color: "#8C8580", fontSize: 11, fontWeight: typo.data.weight },
  recipeListCopy: { flex: 1, minWidth: 0 },
  recipeListName: { color: "#35333A", fontSize: 11, fontWeight: typo.title.weight },
  recipeListNote: { color: "#8C8580", fontSize: 11, fontWeight: typo.body.weight, marginTop: 3 },
  recipeListCount: { color: "#8C8580", fontSize: 11, fontWeight: typo.data.weight, marginLeft: 8 },
  recipeListArrow: { color: "#8C8580", fontSize: 18, fontWeight: typo.label.weight, marginLeft: 6 },
  myCookingBox: {
    borderRadius: 15,
    borderWidth: 1,
    borderColor: "#E5DED6",
  ...
  myCookingTitle: { color: "#35333A", fontSize: 11, fontWeight: typo.title.weight },
  myCookingSummary: { color: "#8C8580", fontSize: 11, fontWeight: typo.label.weight, marginTop: 3 },
  ...
  cookV2MyEyebrow: { fontSize: 11, fontWeight: typo.label.weight, letterSpacing: 0.5, marginBottom: 2 },
  ...
  myIngredientGroupTitle: { color: "#35333A", fontSize: 11, fontWeight: typo.title.weight },
  myIngredientGroupCount: { color: "#D9685F", fontSize: 11, fontWeight: typo.data.weight },
  myIngredientRow: {
    minHeight: 38,
    borderTopWidth: 1,
    borderTopColor: "#EEEAE5",
  ...
  myIngredientName: { color: "#35333A", fontSize: 11, fontWeight: typo.title.weight },
  myIngredientQuantity: { color: "#8C8580", fontSize: 11, fontWeight: typo.data.weight },
  aiRecipeCallout: {
    borderRadius: 14,
    borderWidth: 1,
    borderColor: "#E5DED6",
  ...
  aiRecipeTitle: { color: "#35333A", fontSize: 11, fontWeight: typo.title.weight },
  aiRecipeText: { color: "#8C8580", fontSize: 11, fontWeight: typo.label.weight, lineHeight: 13, marginTop: 3 },
  aiRecipeButton: {
    borderRadius: 10,
    backgroundColor: "#F0EDFF",
    paddingHorizontal: 10,
  ...
  aiRecipeButtonText: { color: "#6556D8", fontSize: 11, fontWeight: typo.label.weight },
  aiPromptBox: {
    borderRadius: 14,
    borderWidth: 1,
    borderColor: "#E5DED6",
  ...
  aiPromptCopyText: { color: "#FFFFFF", fontSize: 11, fontWeight: typo.body.weight },
  aiPromptPreview: {
    color: "#777F8C",
    fontSize: 11,
    fontWeight: typo.caption.weight,
  ...
  recipeLinkIcon: { color: "#D9685F", fontSize: 11, fontWeight: typo.label.weight },
  recipeLinkText: { color: "#D9685F", fontSize: 11, fontWeight: typo.label.weight },
  emptyCooking: {
    backgroundColor: "#FFFFFF",
    borderRadius: 18,
    paddingVertical: 42,
  ...
  emptyCookingTitle: { color: "#4B4745", fontSize: 15, fontWeight: typo.title.weight },
  ...
  emptyCookingActionText: { fontSize: 11, fontWeight: typo.label.weight },
  cookingEyebrow: {
    color: "#A16E35",
    fontSize: 11,
    fontWeight: typo.label.weight,
  ...
  cookingMoreText: { color: "#8C8580", fontSize: 14, fontWeight: typo.label.weight, lineHeight: 16 },
  cookingTitle: {
    color: "#5C4030",
    fontSize: 22,
    fontWeight: typo.title.weight,
  ...
  cookV2SectionLabelText: { fontSize: 11, fontWeight: typo.label.weight },
  cookV2SectionActions: { flexDirection: "row", alignItems: "center", gap: 8 },
  cookV2SectionCount: { fontSize: 11, fontWeight: typo.data.weight },
  cookV2SectionToggle: { width: 16, fontSize: 14, fontWeight: typo.label.weight, textAlign: "center" },
  ingredientRow: {
    minHeight: 45,
    flexDirection: "row",
    alignItems: "center",
  ...
  cookV2IngredientTick: { color: "#FFFFFF", fontSize: 12, fontWeight: typo.label.weight },
  cookV2IngredientNameDone: { textDecorationLine: "line-through" },
  ingredientBody: { flex: 1 },
  ingredientName: { color: "#383534", fontSize: 13, fontWeight: typo.title.weight },
  ingredientOwner: { color: "#96908A", fontSize: 11, marginTop: 2 },
  ingredientQuantity: { color: "#765D49", fontSize: 11, fontWeight: typo.data.weight },
  ...
  emptyStateTitle: { fontSize: 11, fontWeight: typo.title.weight },
  emptyStateDescription: { fontSize: 11, lineHeight: 16, fontWeight: typo.body.weight, marginTop: 3 },
  emptyStateAction: { minHeight: 30, borderRadius: 9, paddingHorizontal: 9, alignItems: "center", justifyContent: "center", marginLeft: 8 },
  emptyStateActionText: { fontSize: 11, fontWeight: typo.label.weight },
  ...
  listMoreText: { fontSize: 11, fontWeight: typo.label.weight },
  listMoreChevron: { fontSize: 11, fontWeight: typo.label.weight, marginLeft: 6 },
  longPressHint: {
    color: "#AAA39C",
    fontSize: 11,
    textAlign: "center",
  ...
  modeText: { color: "#7C8492", fontSize: 13, fontWeight: typo.label.weight },
  modeTextCurrent: { color: "#FFFFFF" },
  sectionAction: { color: "#6556D8", fontSize: 11, fontWeight: typo.label.weight },
  dot: {
    width: 8,
    height: 8,
    borderRadius: 4,
  ...
  date: { fontSize: 11, fontWeight: typo.caption.weight, letterSpacing: 0, marginBottom: 6 },
  title: { fontSize: 29, fontWeight: typo.title.weight, letterSpacing: -1.2 },
  ...
  tabActionTitle: { fontSize: 18, lineHeight: 23, fontWeight: typo.title.weight, letterSpacing: -0.5 },
  tabActionCount: { fontSize: 11, fontWeight: typo.data.weight },
  tabActionButton: {
    minHeight: 38,
    borderRadius: 10,
    paddingHorizontal: 12,
  ...
  tabActionButtonText: { color: "#FFFFFF", fontSize: 13, fontWeight: typo.label.weight },
  sectionTitle: { fontSize: 18, fontWeight: typo.title.weight, letterSpacing: -0.5 },
  ...
  placeControlLabel: { width: 30, fontSize: 11, fontWeight: typo.label.weight },
  placeToolbar: {
    flexDirection: "row",
    alignItems: "center",
  ...
  memoryStatValue: { fontSize: 14, fontWeight: typo.data.weight },
  memoryStatLabel: { fontSize: 10, fontWeight: typo.label.weight, marginTop: 3 },
  photoPickerPreview: {
    height: 176,
    borderRadius: 18,
    borderWidth: 1,
  ...
  photoPickerMarkText: { fontSize: 12, fontWeight: typo.label.weight },
  memoryTile: {
    width: "31.4%",
    aspectRatio: 1,
    borderRadius: 8,
  ...
  placeMiniNumber: { fontSize: 11, fontWeight: typo.data.weight },
  placeMiniInfo: { flex: 1, minWidth: 0, marginLeft: 10 },
  placeMiniTitleRow: { flexDirection: "row", alignItems: "center" },
  placeMiniName: { flex: 1, minWidth: 0, fontSize: 13, fontWeight: typo.title.weight },
  placeMiniStatus: { height: 21, borderRadius: 7, paddingHorizontal: 7, alignItems: "center", justifyContent: "center", marginLeft: 7 },
  placeMiniStatusText: { fontSize: 11, fontWeight: typo.label.weight },
  placeMiniMeta: { fontSize: 11, fontWeight: typo.caption.weight, marginTop: 3 },
  ...
  placeMiniTagText: { fontSize: 11, fontWeight: typo.label.weight },
  placeMiniMore: { fontSize: 11, fontWeight: typo.label.weight, marginLeft: 2 },
