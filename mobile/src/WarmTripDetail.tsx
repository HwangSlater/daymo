...
const styles = StyleSheet.create({
  ...
  memoEditorTitle: { fontSize: 14, fontFamily: typo.title.family },
  memoEditorCancel: { fontSize: 11, fontFamily: typo.label.family },
  memoEmpty: { alignItems: "center", paddingVertical: 20 },
  memoEmptyTitle: { fontSize: 14, fontFamily: typo.title.family },
  ...
  sheetKindText: { fontSize: 11, fontFamily: typo.label.family, letterSpacing: 1 },
  ...
  naverAutoFillText: { fontSize: 11, lineHeight: 15, marginTop: 2 },
  ...
  cookV2MenuNumber: { fontSize: 11, fontFamily: typo.data.family, letterSpacing: 0.5 },
  ...
  emptyCookingTitle: { color: "#4B4745", fontSize: 16, fontFamily: typo.title.family },
  ...
  memoryStatLabel: { fontSize: 11, fontFamily: typo.label.family, marginTop: 2 },
  photoPickerPreview: {
    height: 176,
    borderRadius: 16,
    borderWidth: 1,
