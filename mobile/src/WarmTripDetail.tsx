...
const styles = StyleSheet.create({
  ...
  tripMemoBody: { color: "#35333A", fontSize: 12, lineHeight: 18, marginTop: 6 },
  memoAddButton: {
    minHeight: 58,
    borderRadius: 12,
    borderWidth: 1,
  ...
  memoAddPlus: { fontSize: 22, lineHeight: 24, fontWeight: "500", marginRight: 8 },
  memoAddCopy: { flex: 1 },
  ...
  transportDetailDirection: { fontSize: 11, fontFamily: typo.label.family, marginBottom: 2 },
  ...
  travelMiniTitle: { fontSize: 13, fontFamily: typo.title.family, marginTop: 6 },
  travelMiniBottom: {
    flexDirection: "row",
    alignItems: "center",
    justifyContent: "space-between",
  ...
  travelInfoLabelText: { fontSize: 11, fontFamily: typo.label.family, marginTop: 2 },
  ...
  momentNote: { color: "#A18980", fontSize: 11, marginTop: 4 },
  ...
  diaryTitle: { color: "#35333A", fontSize: 13, fontFamily: typo.title.family, marginTop: 6 },
  ...
  previewPlace: { color: "#9EABC0", fontSize: 11, marginTop: 4 },
  naverField: {
  ...
  naverAutoFillText: { fontSize: 10, lineHeight: 14, marginTop: 2 },
  ...
  placeRecommendLabel: { fontSize: 11, fontFamily: typo.label.family, marginBottom: 6 },
  tagSuggestions: {
    flexDirection: "row",
    flexWrap: "wrap",
    gap: 6,
  ...
  packingJourneyTitle: { fontSize: 12, lineHeight: 17, fontFamily: typo.title.family, marginTop: 2 },
  ...
  packingV2SubTags: { fontSize: 11, fontFamily: typo.label.family, marginTop: 2 },
  packingV2Assignee: {
    minWidth: 38,
    borderRadius: 999,
    paddingHorizontal: 8,
  ...
  assignmentDescription: { fontSize: 11, fontFamily: typo.body.family, marginTop: 2 },
  assignmentRadio: {
    width: 20,
    height: 20,
    borderRadius: 999,
  ...
  cookingImportText: { color: "#8C8580", fontSize: 11, fontFamily: typo.label.family, marginTop: 2 },
  cookingImportGroup: {
    borderRadius: 12,
    borderWidth: 1,
    borderColor: "#E5E3DD",
  ...
  recipeListNote: { color: "#8C8580", fontSize: 11, fontFamily: typo.body.family, marginTop: 2 },
  ...
  myCookingSummary: { color: "#8C8580", fontSize: 11, fontFamily: typo.label.family, marginTop: 2 },
  ...
  aiRecipeText: { color: "#8C8580", fontSize: 11, fontFamily: typo.label.family, lineHeight: 13, marginTop: 2 },
  aiRecipeButton: {
    borderRadius: 8,
    backgroundColor: "#F0EDFF",
    paddingHorizontal: 8,
  ...
  cookingNote: { color: "#9B7555", fontSize: 11, marginTop: 4 },
  recipeLink: {
    alignSelf: "flex-start",
    flexDirection: "row",
    alignItems: "center",
  ...
  emptyStateDescription: { fontSize: 11, lineHeight: 16, fontFamily: typo.body.family, marginTop: 2 },
  ...
  memoryStatLabel: { fontSize: 10, fontFamily: typo.label.family, marginTop: 2 },
  photoPickerPreview: {
    height: 176,
    borderRadius: 16,
    borderWidth: 1,
