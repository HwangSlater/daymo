...
const styles = StyleSheet.create({
  ...
  feedbackToastText: { flex: 1, color: "#FFFFFF", fontSize: 13, fontFamily: typo.label.family },
  ...
  tripMemoEdit: { color: "#746F6A", fontSize: 11, fontFamily: typo.label.family },
  tripMemoDelete: { color: "#D05E58", fontSize: 11, fontFamily: typo.label.family },
  tripMemoAuthor: { color: "#B76A59", fontSize: 11, fontFamily: typo.label.family },
  ...
  memoAddCopy: { flex: 1 },
  memoAddTitle: { fontSize: 13, fontFamily: typo.title.family },
  ...
  memoEditorTitle: { fontSize: 13, fontFamily: typo.title.family },
  memoEditorCancel: { fontSize: 11, fontFamily: typo.label.family },
  memoEmpty: { alignItems: "center", paddingVertical: 22 },
  memoEmptyTitle: { fontSize: 13, fontFamily: typo.title.family },
  ...
  transportOwner: { fontSize: 11, fontFamily: typo.label.family },
  transportStatus: { fontSize: 11, fontFamily: typo.label.family },
  transportMethod: { fontSize: 11, fontFamily: typo.label.family, marginTop: 6 },
  ...
  transportPlace: { fontSize: 11, fontFamily: typo.label.family },
  ...
  transportReturn: { fontSize: 11, fontFamily: typo.label.family, marginTop: 8 },
  transportFormPreview: { borderWidth: 1, borderRadius: 12, padding: 13, marginBottom: 16 },
  transportFormOwner: { fontSize: 11, fontFamily: typo.label.family },
  ...
  transportSwitchHintArrow: { fontSize: 13, lineHeight: 15, fontFamily: typo.label.family },
  ...
  pairedFieldArrowText: { fontSize: 13, lineHeight: 15, fontFamily: typo.label.family },
  transportDetailBlock: { borderBottomWidth: 1, paddingBottom: 9, marginBottom: 9 },
  transportDetailDirection: { fontSize: 11, fontFamily: typo.label.family, marginBottom: 3 },
  infoManageButton: { minHeight: 34, borderRadius: 9, alignItems: "center", justifyContent: "center", marginTop: 7 },
  infoManageButtonText: { fontSize: 11, fontFamily: typo.label.family },
  ...
  travelMiniMarkText: { fontSize: 11, fontFamily: typo.label.family },
  travelMiniLabel: { fontSize: 11, fontFamily: typo.label.family, letterSpacing: 0.5 },
  travelMiniTitle: { fontSize: 13, fontFamily: typo.title.family, marginTop: 7 },
  travelMiniBottom: {
    flexDirection: "row",
    alignItems: "center",
    justifyContent: "space-between",
  ...
  travelInfoLabelText: { fontSize: 11, fontFamily: typo.label.family, marginTop: 1 },
  travelInfoCopy: { flex: 1, minWidth: 0 },
  travelInfoTitle: { fontSize: 12, fontFamily: typo.title.family },
  travelInfoMeta: { fontSize: 11, fontFamily: typo.caption.family, marginTop: 3 },
  travelInfoArrowBox: {
    width: 27,
    height: 27,
    borderRadius: 9,
  ...
  travelInfoArrow: { fontSize: 17, lineHeight: 18, fontFamily: typo.label.family },
  ...
  keepsakeStyle: { color: "#B06C5E", fontSize: 11, fontFamily: typo.label.family },
  ...
  diaryTitle: { color: "#35333A", fontSize: 13, fontFamily: typo.title.family, marginTop: 7 },
  ...
  sheetKindText: { fontSize: 10, fontFamily: typo.label.family, letterSpacing: 0.8 },
  ...
  infoPanelCloseText: { fontSize: 15, lineHeight: 19, fontFamily: typo.label.family },
  ...
  stayPickerLabel: { fontSize: 13, fontFamily: typo.label.family },
  stayPickerValue: { fontSize: 11, fontFamily: typo.data.family },
  sheetSubmit: {
    height: 50,
    borderRadius: 17,
    backgroundColor: "#17233D",
  ...
  infoLineLabel: { color: "#858D9A", fontSize: 11, fontFamily: typo.label.family },
  infoLineValue: {
    color: "#17233D",
    fontSize: 13,
    fontFamily: typo.data.family,
  ...
  tripMetaLabel: { color: "#6F7888", fontSize: 11, fontFamily: typo.label.family },
  tripMetaValue: {
    color: "#17233D",
    fontSize: 13,
    fontFamily: typo.data.family,
  ...
  optionText: { color: "#747D8D", fontSize: 11, fontFamily: typo.label.family },
  ...
  previewDay: { color: "#DFFFFA", fontSize: 11, fontFamily: typo.data.family },
  previewDateNo: {
    color: "#FFFFFF",
    fontSize: 23,
    lineHeight: 26,
  ...
  naverAutoFillTitle: { fontSize: 12, fontFamily: typo.title.family },
  ...
  naverAutoFillButtonText: { color: "#16844E", fontSize: 11, fontFamily: typo.label.family },
  naverLogo: {
    width: 30,
    height: 30,
    borderRadius: 9,
  ...
  naverTitle: { color: "#184D36", fontSize: 12, fontFamily: typo.title.family },
  ...
  linkState: { color: "#278153", fontSize: 11, fontFamily: typo.label.family, marginTop: 8 },
  mapLink: {
  ...
  mapLinkIconText: { color: "#FFFFFF", fontSize: 11, fontFamily: typo.label.family },
  mapLinkText: { color: "#23714B", fontSize: 11, fontFamily: typo.label.family },
  mapLinkArrow: { color: "#23714B", fontSize: 11, marginLeft: 4 },
  placeFilterText: { color: "#7C8390", fontSize: 11, fontFamily: typo.label.family },
  placeFilterTextActive: { color: "#FFFFFF" },
  placeAddText: { color: "#6556D8", fontSize: 11, fontFamily: typo.label.family },
  placeList: { gap: 8 },
  placeFormIntro: {
    minHeight: 34,
    flexDirection: "row",
  ...
  placeRequiredBadgeText: { fontSize: 11, fontFamily: typo.label.family },
  placeFormText: {
    color: "#61598C",
    fontSize: 11,
    fontFamily: typo.label.family,
  ...
  resultCountText: { color: "#6556D8", fontSize: 11, fontFamily: typo.data.family },
  tagFilterChipActive: { backgroundColor: "#8B7CF6" },
  tagFilterLabel: { color: "#777F8C", fontSize: 11, fontFamily: typo.label.family },
  tagFilterLabelActive: { color: "#FFFFFF" },
  placeTags: { flexDirection: "row", flexWrap: "wrap", gap: 5, marginTop: 9 },
  placeTagText: { color: "#6556D8", fontSize: 11, fontFamily: typo.label.family },
  tagEditor: { marginBottom: 18 },
  selectorLabel: { marginBottom: 9 },
  placeRecommendLabel: { fontSize: 11, fontFamily: typo.label.family, marginBottom: 7 },
  tagSuggestions: {
    flexDirection: "row",
    flexWrap: "wrap",
    gap: 6,
  ...
  tagSuggestionText: { color: "#747C88", fontSize: 11, fontFamily: typo.label.family },
  ...
  draftTagText: { color: "#6556D8", fontSize: 11, fontFamily: typo.label.family },
  deletePlace: {
    height: 44,
    alignItems: "center",
    justifyContent: "center",
  ...
  deletePlaceText: { color: "#D6534A", fontSize: 11, fontFamily: typo.label.family },
  fullScheduleText: { color: "#6556D8", fontSize: 11, fontFamily: typo.label.family },
  ...
  packingManageTitle: { fontSize: 14, fontFamily: typo.title.family },
  packingManageHint: { fontSize: 11, fontFamily: typo.caption.family, marginTop: 3 },
  packingShowAll: {
    borderWidth: 1,
    borderRadius: 999,
    paddingHorizontal: 10,
  ...
  packingShowAllText: { fontSize: 11, fontFamily: typo.label.family },
  ...
  ownerStatName: { color: "#17233D", fontSize: 11, fontFamily: typo.title.family },
  ownerStatCount: {
    color: "#89909C",
    fontSize: 11,
    fontFamily: typo.data.family,
  ...
  packingFilterLabel: { width: 38, fontSize: 11, fontFamily: typo.label.family },
  ...
  packingFilterChipText: { fontSize: 11, fontFamily: typo.label.family },
  packingFilterMore: {
    borderWidth: 1,
    borderRadius: 999,
    paddingHorizontal: 10,
  ...
  packingFilterMoreText: { fontSize: 11, fontFamily: typo.label.family },
  ...
  packingOwnerAvatarText: { fontSize: 11, fontFamily: typo.label.family },
  packingOwnerCopy: { flex: 1 },
  packingOwnerName: { fontSize: 15, fontFamily: typo.title.family },
  packingOwnerProgress: { fontSize: 11, fontFamily: typo.label.family, marginTop: 2 },
  packingCollapseIcon: {
    fontSize: 16,
    fontFamily: typo.label.family,
    paddingHorizontal: 5,
  ...
  packingTagHeadText: { fontSize: 11, fontFamily: typo.label.family },
  packingTagLine: {
    flex: 1,
    height: StyleSheet.hairlineWidth,
    marginHorizontal: 8,
  },
  packingTagCount: { fontSize: 11, fontFamily: typo.data.family },
  ...
  packingTiming: { fontSize: 11, fontFamily: typo.label.family },
  packingOwnerChange: {
    borderRadius: 999,
    paddingHorizontal: 9,
    paddingVertical: 5,
  },
  packingOwnerChangeText: { fontSize: 11, fontFamily: typo.label.family },
  ...
  packingSuitcaseStickerText: { fontSize: 11, fontFamily: typo.label.family },
  packingSuitcaseFeet: {
    width: 24,
    flexDirection: "row",
    justifyContent: "space-between",
  ...
  packingJourneyTitle: { fontSize: 12, lineHeight: 17, fontFamily: typo.title.family, marginTop: 1 },
  ...
  packingV2TagButtonText: { fontSize: 11, fontFamily: typo.label.family },
  packingV2TagChevron: { fontSize: 11, fontFamily: typo.label.family, marginTop: -2 },
  ...
  packingV2OwnerName: { fontSize: 11, fontFamily: typo.title.family },
  packingV2OwnerCount: { fontSize: 11, fontFamily: typo.data.family },
  packingV2Group: {
    borderWidth: 1,
    borderRadius: 14,
    overflow: "hidden",
  ...
  packingV2GroupTitle: { fontSize: 13, fontFamily: typo.title.family },
  packingV2GroupProgress: { fontSize: 11, fontFamily: typo.label.family, marginTop: 2 },
  packingV2GroupCount: {
    borderRadius: 999,
    paddingHorizontal: 8,
    paddingVertical: 5,
  },
  packingV2GroupCountText: { fontSize: 11, fontFamily: typo.data.family },
  packingV2Row: {
    minHeight: 49,
    paddingHorizontal: 12,
    flexDirection: "row",
  ...
  packingV2Quantity: { fontSize: 11, fontFamily: typo.data.family },
  packingV2SubTags: { fontSize: 11, fontFamily: typo.label.family, marginTop: 3 },
  packingV2Assignee: {
    minWidth: 38,
    borderRadius: 999,
    paddingHorizontal: 8,
  ...
  packingV2CompletedTitle: { fontSize: 11, fontFamily: typo.title.family },
  packingV2CompletedToggle: { fontSize: 11, fontFamily: typo.label.family },
  packingListTools: {
    borderTopWidth: 1,
    marginTop: 22,
    paddingTop: 14,
  ...
  packingListToolsTitle: { fontSize: 11, fontFamily: typo.title.family },
  packingListToolsHint: { fontSize: 11, fontFamily: typo.caption.family, marginTop: 3 },
  packingToolButton: {
    minWidth: 48,
    height: 34,
    borderWidth: 1,
  ...
  packingToolButtonText: { fontSize: 11, fontFamily: typo.label.family },
  tagPickerGrid: {
    flexDirection: "row",
    flexWrap: "wrap",
    gap: 8,
  ...
  tagPickerName: { fontSize: 11, fontFamily: typo.title.family, flex: 1 },
  tagPickerCount: { fontSize: 11, fontFamily: typo.data.family },
  ...
  assignmentAvatarText: { fontSize: 11, fontFamily: typo.label.family },
  assignmentCopy: { flex: 1 },
  assignmentName: { fontSize: 13, fontFamily: typo.title.family },
  assignmentDescription: { fontSize: 11, fontFamily: typo.body.family, marginTop: 3 },
  assignmentRadio: {
    width: 20,
    height: 20,
    borderRadius: 10,
  ...
  packingAssigneeOptionText: { fontSize: 11, fontFamily: typo.label.family },
  ...
  cookingImportTitle: { color: "#35333A", fontSize: 11, fontFamily: typo.title.family },
  cookingImportText: { color: "#8C8580", fontSize: 11, fontFamily: typo.label.family, marginTop: 3 },
  cookingImportGroup: {
    borderRadius: 14,
    borderWidth: 1,
    borderColor: "#E5E3DD",
  ...
  cookingImportGroupTitle: { color: "#35333A", fontSize: 11, fontFamily: typo.title.family },
  cookingImportGroupCount: { color: "#8C8580", fontSize: 11, fontFamily: typo.data.family },
  cookingImportRow: {
    minHeight: 45,
    borderTopWidth: 1,
  ...
  cookingImportCheckText: { color: "#FFFFFF", fontSize: 11, fontFamily: typo.label.family },
  cookingImportItemCopy: { flex: 1 },
  cookingImportItemName: { color: "#35333A", fontSize: 11, fontFamily: typo.title.family },
  cookingImportItemMeta: { color: "#8C8580", fontSize: 11, fontFamily: typo.caption.family, marginTop: 3 },
  packingQuantity: { color: "#858D99", fontSize: 11, fontFamily: typo.data.family },
  settingHint: {
    color: "#7A7F89",
    fontSize: 11,
    lineHeight: 17,
  ...
  cookV2ProgressBadgeLabel: { fontSize: 11, fontFamily: typo.label.family, marginTop: 2 },
  ...
  recipeSelectorTitle: { color: "#777F8C", fontSize: 11, fontFamily: typo.title.family },
  recipeSelectorActions: { flexDirection: "row", alignItems: "center", gap: 8 },
  recipeSelectorCount: { color: "#92909A", fontSize: 11, fontFamily: typo.data.family },
  recipeSelectorMore: { color: "#D9685F", fontSize: 11, fontFamily: typo.label.family },
  ...
  cookV2MenuNumber: { fontSize: 11, fontFamily: typo.data.family, letterSpacing: 0.7 },
  cookV2MenuCount: { fontSize: 11, fontFamily: typo.data.family },
  cookV2MenuName: { fontSize: 12, fontFamily: typo.title.family },
  cookV2MenuNote: { fontSize: 11, fontFamily: typo.body.family, marginTop: 4 },
  recipeList: {
    borderRadius: 14,
    borderWidth: 1,
    borderColor: "#E5DED6",
  ...
  recipeListNumberText: { color: "#8C8580", fontSize: 11, fontFamily: typo.data.family },
  recipeListCopy: { flex: 1, minWidth: 0 },
  recipeListName: { color: "#35333A", fontSize: 11, fontFamily: typo.title.family },
  recipeListNote: { color: "#8C8580", fontSize: 11, fontFamily: typo.body.family, marginTop: 3 },
  recipeListCount: { color: "#8C8580", fontSize: 11, fontFamily: typo.data.family, marginLeft: 8 },
  ...
  myCookingTitle: { color: "#35333A", fontSize: 11, fontFamily: typo.title.family },
  myCookingSummary: { color: "#8C8580", fontSize: 11, fontFamily: typo.label.family, marginTop: 3 },
  ...
  cookV2MyEyebrow: { fontSize: 11, fontFamily: typo.label.family, letterSpacing: 0.5, marginBottom: 2 },
  ...
  myIngredientGroupTitle: { color: "#35333A", fontSize: 11, fontFamily: typo.title.family },
  myIngredientGroupCount: { color: "#D9685F", fontSize: 11, fontFamily: typo.data.family },
  myIngredientRow: {
    minHeight: 38,
    borderTopWidth: 1,
    borderTopColor: "#EEEAE5",
  ...
  myIngredientName: { color: "#35333A", fontSize: 11, fontFamily: typo.title.family },
  myIngredientQuantity: { color: "#8C8580", fontSize: 11, fontFamily: typo.data.family },
  aiRecipeCallout: {
    borderRadius: 14,
    borderWidth: 1,
    borderColor: "#E5DED6",
  ...
  aiRecipeTitle: { color: "#35333A", fontSize: 11, fontFamily: typo.title.family },
  aiRecipeText: { color: "#8C8580", fontSize: 11, fontFamily: typo.label.family, lineHeight: 13, marginTop: 3 },
  aiRecipeButton: {
    borderRadius: 10,
    backgroundColor: "#F0EDFF",
    paddingHorizontal: 10,
  ...
  aiRecipeButtonText: { color: "#6556D8", fontSize: 11, fontFamily: typo.label.family },
  aiPromptBox: {
    borderRadius: 14,
    borderWidth: 1,
    borderColor: "#E5DED6",
  ...
  aiPromptCopyText: { color: "#FFFFFF", fontSize: 11, fontFamily: typo.body.family },
  aiPromptPreview: {
    color: "#777F8C",
    fontSize: 11,
    fontFamily: typo.caption.family,
  ...
  recipeLinkIcon: { color: "#D9685F", fontSize: 11, fontFamily: typo.label.family },
  recipeLinkText: { color: "#D9685F", fontSize: 11, fontFamily: typo.label.family },
  emptyCooking: {
    backgroundColor: "#FFFFFF",
    borderRadius: 18,
    paddingVertical: 42,
  ...
  emptyCookingTitle: { color: "#4B4745", fontSize: 15, fontFamily: typo.title.family },
  ...
  emptyCookingActionText: { fontSize: 11, fontFamily: typo.label.family },
  cookingEyebrow: {
    color: "#A16E35",
    fontSize: 11,
    fontFamily: typo.label.family,
  ...
  cookV2SectionLabelText: { fontSize: 11, fontFamily: typo.label.family },
  cookV2SectionActions: { flexDirection: "row", alignItems: "center", gap: 8 },
  cookV2SectionCount: { fontSize: 11, fontFamily: typo.data.family },
  ...
  ingredientName: { color: "#383534", fontSize: 13, fontFamily: typo.title.family },
  ingredientOwner: { color: "#96908A", fontSize: 11, marginTop: 2 },
  ingredientQuantity: { color: "#765D49", fontSize: 11, fontFamily: typo.data.family },
  ...
  emptyStateTitle: { fontSize: 11, fontFamily: typo.title.family },
  emptyStateDescription: { fontSize: 11, lineHeight: 16, fontFamily: typo.body.family, marginTop: 3 },
  emptyStateAction: { minHeight: 30, borderRadius: 9, paddingHorizontal: 9, alignItems: "center", justifyContent: "center", marginLeft: 8 },
  emptyStateActionText: { fontSize: 11, fontFamily: typo.label.family },
  ...
  listMoreText: { fontSize: 11, fontFamily: typo.label.family },
  listMoreChevron: { fontSize: 11, fontFamily: typo.label.family, marginLeft: 6 },
  longPressHint: {
    color: "#AAA39C",
    fontSize: 11,
    textAlign: "center",
  ...
  modeText: { color: "#7C8492", fontSize: 13, fontFamily: typo.label.family },
  modeTextCurrent: { color: "#FFFFFF" },
  sectionAction: { color: "#6556D8", fontSize: 11, fontFamily: typo.label.family },
  dot: {
    width: 8,
    height: 8,
    borderRadius: 4,
  ...
  title: { fontSize: 29, fontFamily: typo.title.family, letterSpacing: -1.2 },
  ...
  tabActionCount: { fontSize: 11, fontFamily: typo.data.family },
  tabActionButton: {
    minHeight: 38,
    borderRadius: 10,
    paddingHorizontal: 12,
  ...
  tabActionButtonText: { color: "#FFFFFF", fontSize: 13, fontFamily: typo.label.family },
  ...
  memoryStatLabel: { fontSize: 10, fontFamily: typo.label.family, marginTop: 3 },
  photoPickerPreview: {
    height: 176,
    borderRadius: 18,
    borderWidth: 1,
  ...
  placeMiniNumber: { fontSize: 11, fontFamily: typo.data.family },
  placeMiniInfo: { flex: 1, minWidth: 0, marginLeft: 10 },
  placeMiniTitleRow: { flexDirection: "row", alignItems: "center" },
  placeMiniName: { flex: 1, minWidth: 0, fontSize: 13, fontFamily: typo.title.family },
  placeMiniStatus: { height: 21, borderRadius: 7, paddingHorizontal: 7, alignItems: "center", justifyContent: "center", marginLeft: 7 },
  placeMiniStatusText: { fontSize: 11, fontFamily: typo.label.family },
  placeMiniMeta: { fontSize: 11, fontFamily: typo.caption.family, marginTop: 3 },
  ...
  placeMiniTagText: { fontSize: 11, fontFamily: typo.label.family },
  placeMiniMore: { fontSize: 11, fontFamily: typo.label.family, marginLeft: 2 },
