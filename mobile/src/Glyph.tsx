...
const filledPaths = {
   ...
   * 외곽선으로 그렸다. 이음매는 둥글게 처리해 다른 그림들과 결을 맞춘다.
   */
  gear: "M20.6 13.9 20.6 10.1 18.4 10.3 17.7 8.7 19.4 7.3 16.7 4.6 15.3 6.3 13.7 5.6 13.9 3.4 10.1 3.4 10.3 5.6 8.7 6.3 7.3 4.6 4.6 7.3 6.3 8.7 5.6 10.3 3.4 10.1 3.4 13.9 5.6 13.7 6.3 15.3 4.6 16.7 7.3 19.4 8.7 17.7 10.3 18.4 10.1 20.6 13.9 20.6 13.7 18.4 15.3 17.7 16.7 19.4 19.4 16.7 17.7 15.3 18.4 13.7ZM12 9.2a2.8 2.8 0 1 0 0 5.6 2.8 2.8 0 1 0 0-5.6",
  /** 반짝 스티커. 네 갈래로 뻗는 빛이다. */
