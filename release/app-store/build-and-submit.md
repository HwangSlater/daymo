...
2. 내부 테스터(운영자)로 실제 기기에서 확인: 가입·소셜 로그인 4종·초대 링크로 앱 열기·사진 올리기/받기·계정 삭제와 취소.
...
| 1.2 사용자 생성 콘텐츠 | 신고, 차단, 운영자 연락 방법 — 신고·차단 구현 필요 |
| 5.1.1 개인정보 | 앱 안에서 처리방침을 열 수 있다 — 로그인 화면, 내 프로필 아래 링크 |
