...
<table>
  ...
  <tr>
    ...
    <td width="25%" valign="top">여행 목록입니다. 전체·예정·추억으로 걸러 보고, 새 여행을 만들 때 이번에 함께 갈 사람을 고릅니다. 같은 목록을 지도와 캘린더로도 볼 수 있습니다.</td>
...
| **기록** | 여행 사진과 일기를 날짜별로 남겨 두고 여행이 끝난 뒤에도 꺼내 봅니다. 사진과 문구를 골라 여행 기념 카드를 만듭니다. |
| **지도와 캘린더** | 여행 목록을 지역 지도나 캘린더로 바꿔 봅니다. 어디를 다녔는지, 언제 비어 있는지가 한눈에 보입니다. |
