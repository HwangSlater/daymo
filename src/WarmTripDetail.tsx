...
export function WarmTripDetail({
  ...
  const [tripNotes, setTripNotes] = useState([
    ...
    { author: "하늘 · 어제 22:15", body: "소나기식당 일요일 13:30 예약 확인" },
  ]);
...
function TripOverview({
  ...
  const [transportations, setTransportations] = useState<Transportation[]>([
    ...
    { id: "yeoul-out", owner: "여울", direction: "가는 편", method: "버스", date: "금 · 21", departure: "진주", departureTime: "07:50", arrival: "전주", arrivalTime: "11:25", status: "예매 완료" },
    { id: "yeoul-back", owner: "여울", direction: "오는 편", method: "버스", date: "일 · 23", departure: "전주", departureTime: "21:30", arrival: "진주", arrivalTime: "01:05", status: "예매 완료" },
  ]);
  ...
  const [stay, setStay] = useState({ name: "달빛한옥", checkin: "8월 21일 15:00", checkout: "8월 23일 12:00", address: "전주 한옥마을 은행로 12" });
  ...
  return (
    <View>
      ...
      >
        ...
        <DetailField label="장소" value={reservationDraft.place} onChangeText={(place) => setReservationDraft((current) => ({ ...current, place }))} placeholder="예: 전주 한옥마을" />
      </DetailSheet>
      <DetailSheet
        visible={sheet === "stay"}
...
const styles = StyleSheet.create({
  ...
  transportOwner: { fontSize: 9, fontWeight: "900" },
  transportStatus: { fontSize: 7, fontWeight: "800" },
  transportMethod: { fontSize: 10, fontWeight: "900", marginTop: 6 },
  ...
  transportPlace: { fontSize: 9, fontWeight: "900" },
  transportTime: { fontSize: 10, fontWeight: "900", marginTop: 2 },
