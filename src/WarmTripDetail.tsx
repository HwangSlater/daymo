    ...
    <View>
      ...
      >
        ...
        <View style={styles.placeInfo}>
          ...
          <Text style={styles.placeName}>소나기식당</Text>
      ...
      <View style={styles.twoCards}>
        ...
        >
          ...
          <Text style={styles.smallTitle}>달빛한옥</Text>
        ...
        {hasKitchen && (
          ...
          >
            ...
            <Text style={styles.smallTitle}>버섯전골</Text>
    ...
    <View>
      <View style={styles.cookingHero}>
        <View>
          ...
          <Text style={styles.cookingTitle}>버섯전골</Text>
        </View>
...
function Memories() {
  const [notes, setNotes] = useState([
    ...
    {
      author: "찬희 · 어제 22:15",
      body: "소나기식당은 일요일 13:30으로 생각하고 있어요.",
    },
  ]);
