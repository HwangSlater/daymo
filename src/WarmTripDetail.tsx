...
function TripOverview({
  ...
  const [transportations, setTransportations] = useState<Transportation[]>([
    ...
    { id: "yeoul-out", owner: "여울", direction: "가는 편", method: "버스", service: "우등", date: "금 · 21", departure: "진주", departureTime: "07:50", arrival: "전주", arrivalTime: "11:25", status: "예매 완료" },
    { id: "yeoul-back", owner: "여울", direction: "오는 편", method: "버스", service: "우등", date: "일 · 23", departure: "전주", departureTime: "21:30", arrival: "진주", arrivalTime: "01:05", status: "예매 완료" },
  ]);
  ...
  return (
    <View>
      ...
      >
        ...
        <InfoLine label="장소" value="전주 한옥마을" />
      </InfoPanel>
      <InfoPanel
        visible={sheet === "stay"}
        title="달빛한옥"
      ...
      >
        ...
        <InfoLine label="주소" value="전주 한옥마을 은행로 12" />
      </InfoPanel>
      <InfoPanel
